-- First remove the defective function and trigger
DROP FUNCTION IF EXISTS public.handle_new_doctor_profile() CASCADE;

-- Create the correct handle_new_user function to automatically create profiles when users sign up
