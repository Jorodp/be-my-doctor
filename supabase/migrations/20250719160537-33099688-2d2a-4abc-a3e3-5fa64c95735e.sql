...
CREATE POLICY IF NOT EXISTS "Admin can manage doctor documents"
ON storage.objects
FOR ALL
TO authenticated
USING (
...
-- Asegurar que el bucket doctor-documents tenga las políticas correctas
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES ('doctor-documents', 'doctor-documents', false, 52428800, ARRAY['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'application/pdf'])
